...
function ScreenHeader({ title, onBack, right }) {
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 8, padding: "14px 18px 12px", position: "sticky", top: 0, background: "rgba(11,11,13,0.92)", backdropFilter: "blur(12px)", zIndex: 10, borderBottom: `1px solid ${T.border}` }}>
      {onBack && (
...
export default function VaultApp() {
  return (
    <div style={{ ...body, height: "100dvh", background: T.bg }}>
